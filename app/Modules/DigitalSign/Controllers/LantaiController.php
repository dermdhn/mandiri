...
class LantaiController extends BaseController
{
    ...
    protected $filters = [];
    protected $add_action = [ [0 => 'rooms.read', 1 =>['floor_id', 'id'], 2 => 'Ruangan', 3 => 'btn-sm', 4=>'bi-menu-down']]; # berisi array action [ [0 => route_name, 1 => route_params ['key_route', 'nm_field'], 2 => btn_title, 3 => add_class, 4 => btn_icon] ]
    protected $data = [];
    protected $q = NULL;
    protected $help;
    protected $app;
        ...
        $this->form_filter = [
            'floor_number' => [
                ...
                1 => [
                    ...
                    [
                        ['Form', 'text'],
                        ['floor_number', NULL, ['class' => 'form-control', 'id' => 'floor_number', 'placeholder' => 'Lantai 1']]
                    ]
                ]
            ]
        ];
